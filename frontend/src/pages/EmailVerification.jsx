...
export default function EmailVerification() {
	...
	const { error, loading, verifyEmail } = useAuthStore();
			...
			>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<motion.button
						...
						className="w-full bg-gradient-to-r from-gray-500 to-blue-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-gray-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 disabled:opacity-50"
					>
